...
const AdminDashboard = () => {
  ...
  { id: 14, name: "Nail Polish Set", category: "Makeup", price: 980, stock: 20, image: "/images/lipstick.jpg" },
  ...
  const fetchCustomers = async () => {
    try {
      ...
      const mockCustomers = [
        { id: 1, name: "Sarah Johnson", email: "sarah@example.com", orders: 5, totalSpent: 12500, joinDate: "2023-01-15" },
        { id: 2, name: "Michael Brown", email: "michael@example.com", orders: 2, totalSpent: 4500, joinDate: "2023-03-22" },
        { id: 3, name: "Emma Wilson", email: "emma@example.com", orders: 8, totalSpent: 21000, joinDate: "2022-11-05" },
        { id: 4, name: "David Lee", email: "david@example.com", orders: 3, totalSpent: 7200, joinDate: "2023-05-18" },
      ];
